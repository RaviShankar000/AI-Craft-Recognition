...
const validateRegister = [
  ...
  body('role')
    .optional()
    .custom((value) => {
      throw new Error('Role cannot be specified during registration. Default role will be assigned.');
    }),
...
const validateOrder = [
  ...
  body('shippingAddress')
    ...
    .isLength({ min: 10, max: 300 }).withMessage('Shipping address must be between 10 and 300 characters'),
